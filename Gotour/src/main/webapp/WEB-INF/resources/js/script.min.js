...
/*global jRespond */
var jPM = {},
    PLUGINS_PATH = "/Gotour/resources/plugins/",
...
jQuery(document).ready(function() {
    ...
    jQuery(".colour-switcher a").click(function() {
        var e = jQuery(this).attr("href").replace("#", ""),
            t = 3 * Math.floor(Math.random() * 6);
        jQuery(".colour-switcher a").removeClass("active");
        jQuery(".colour-switcher a." + e).addClass("active");
        e !== n ? jQuery("#colour-scheme").attr("href", "css/colour-" + e + ".css?x=" + t) : jQuery("#colour-scheme").attr("href", "#")
    });
    ...
    if (jQuery("[data-toggle=switch]").length > 0) {
        ...
        jQuery().themeLoadPlugin(["bootstrap-switch/build/js/bootstrap-switch.min.js"], ["bootstrap-switch/build/css/bootstrap3/bootstrap-switch.min.css"], r)
    }
